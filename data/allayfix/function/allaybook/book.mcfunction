...
execute if data entity @n[type=minecraft:allay,distance=0..1] HandItems[0].id run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1,components:{"minecraft:custom_data":{allayfix.item:0}}}}
execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:stone",components:{"minecraft:custom_data":{allayfix.item:0}}}}] run data modify entity @s Item set from entity @n[type=minecraft:allay,distance=0..1] HandItems[0]
execute if data entity @n[type=minecraft:allay,distance=0..1] Inventory[0] run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1,components:{"minecraft:custom_data":{allayfix.item:1}}}}
execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:stone",components:{"minecraft:custom_data":{allayfix.item:1}}}}] run data modify entity @s Item set from entity @n[type=minecraft:allay,distance=0..1] Inventory[0]
