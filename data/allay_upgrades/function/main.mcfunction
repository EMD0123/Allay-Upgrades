...
# in_reach
execute if score in_reach allay_upgrades.gamerules matches 1 as @e[type=minecraft:allay] at @s unless data entity @s HandItems[0].id if predicate allay_upgrades:50 if predicate allay_upgrades:50 if block ~ ~-3 ~ minecraft:air run data modify entity @s Motion[1] set value -.1d
