...
execute if data entity @s equipment.mainhand.id run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1,components:{"minecraft:custom_data":{allay_upgrades.item:0}}}}
data modify entity @n[type=minecraft:item,nbt={Item:{id:"minecraft:stone",components:{"minecraft:custom_data":{allay_upgrades.item:0}}}}] Item set from entity @s equipment.mainhand
...
data remove entity @n[tag=allay_upgrades.selected] Item.components."minecraft:custom_data".entitydata.equipment.mainhand
