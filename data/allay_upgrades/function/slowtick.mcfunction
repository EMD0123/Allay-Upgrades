...
execute as @e[type=minecraft:allay,limit=1,sort=random] at @s run attribute @s minecraft:generic.flying_speed modifier remove minecraft:eae3f3f1-bc38-4a3c-b45d-5cca9eb97fe3
